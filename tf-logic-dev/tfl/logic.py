...
# -------- CONNECTIVE TENSORS ----------#
class NotNG(FormulaTensor):

    def apply_op(self, args):

        return 1-args[0]

class NotNT(FormulaTensor):

    def __init__(self, args):
        self.tnorm = World.tnorm
        super(NotT, self).__init__(args)
...
# ------------ PROXIES OPERATIONS --------------------#
def not_n(*args):
    res = LogicFactory.create(NOT)(args)
    return res
